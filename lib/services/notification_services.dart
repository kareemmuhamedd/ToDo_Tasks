...
class NotifyHelper {
  ...
  initializeNotification() async {
    ...
    AndroidInitializationSettings('notebook2');
  ...
  cancelNotification(Task task) async {
    ...
    print('one notification is canceled');
  }
  cancelAllNotification() async {
    await flutterLocalNotificationsPlugin.cancelAll();
    print('all notification are canceled');
  }
  ...
  /// function for send notification you selected before the task time ((Your Remind))
